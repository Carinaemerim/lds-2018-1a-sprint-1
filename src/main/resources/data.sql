...
--Evaluation
INSERT INTO  EVALUATION (ID ,EVALUATION_TYPE, DOCUMENT_ID , CONSIDERATIONS, STATUS) VALUES (500, 'Advice', 101, 'Consideracoes do tema estao aqui. bom tema!', 0);
INSERT INTO  EVALUATION (ID ,EVALUATION_TYPE, DOCUMENT_ID , CONSIDERATIONS, STATUS) VALUES (501, 'Advice', 105, 'Consideracoes do Proposta estao aqui. Melhor tentar novamente!', 2);
INSERT INTO  EVALUATION (ID ,EVALUATION_TYPE, DOCUMENT_ID , CONSIDERATIONS, STATUS) VALUES (502, 'Advice', 103, 'Consideracoes do Proposta estao aqui. Parabéns!!', 0);
INSERT INTO  EVALUATION (ID ,EVALUATION_TYPE, DOCUMENT_ID , CONSIDERATIONS ,ADEQUACY_OF_PRESENTATION ,CLOSING_EXPECTED_TIME ,CONCLUSION ,DEVELOPMENT_IN_LOGICAL_SEQUENCE ,EXPERIENCED_SOLUTION ,LITERATURE_REVIEW ,METHODOLOGY ,OBJECTIVE ,PRESENTATION ,SUBJECT_DOMAIN ,THEORETICAL_APPROACH ,VOCABULARY )
  VALUES (503, 'Grade', 104,'condisedariosn do tcc ok foi bom',7,8,7,8,7,8,9,6,5,4,3,7);
INSERT INTO  EVALUATION (ID ,EVALUATION_TYPE, DOCUMENT_ID , CONSIDERATIONS, STATUS) VALUES (504, 'Advice', 102, 'Bom tema, parabéns!', 0);
